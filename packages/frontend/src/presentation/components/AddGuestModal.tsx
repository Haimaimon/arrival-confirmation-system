/**
 * Presentation Layer - Add Guest Modal
 * Beautiful modal for adding a new guest with validation
 */

import { FC, useState, FormEvent, ChangeEvent } from 'react';
import { Modal } from './Modal';
import { Button } from './Button';
import { useCreateGuest } from '../../application/hooks/useGuests';
...
export const AddGuestModal: FC<AddGuestModalProps> = ({ isOpen, onClose, eventId }) => {
